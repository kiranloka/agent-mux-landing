        ...
        <section id="install" aria-label="Hero section" className="relative min-h-[90vh] flex flex-col justify-start items-center text-center pt-32 pb-0 overflow-hidden w-full">
          ...
          <div className="relative z-10 w-full max-w-6xl mx-auto px-6">
            ...
            <div className="mt-8 gap-4 flex flex-col sm:flex-row justify-center items-center">
              <a href={installScriptUrl} aria-label="Download agentmux install script" className="w-full sm:w-auto bg-green-400 text-zinc-950 font-mono font-bold px-6 py-2.5 rounded hover:bg-green-300 transition-colors shadow-[0_0_20px_rgba(74,222,128,0.2)] inline-block text-center">
                download install.sh
              </a>
        ...
        <section id="pricing" aria-label="Pricing" className="py-24 border-t border-zinc-800/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 flex flex-col">
              ...
              <a href={installScriptUrl} aria-label="Download the agentmux install script" className="w-full border border-zinc-700 text-zinc-300 font-mono px-6 py-3 rounded hover:border-zinc-500 transition-colors text-center">
                get started
              </a>
            </div>
